...
func newUpdateCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&efiURL, "efi-url", "", "UEFI: fetch the .EFI from this URL instead of the latest release")
	cmd.Flags().StringVar(&stage1File, "stage1-file", "", "BIOS: local stage1.bin instead of the latest release")
	cmd.Flags().StringVar(&stage1URL, "stage1-url", "", "BIOS: fetch stage1.bin from this URL instead of the latest release")
	cmd.Flags().StringVar(&stage2File, "stage2-file", "", "BIOS: local stage2.bin instead of the latest release")
	cmd.Flags().StringVar(&stage2URL, "stage2-url", "", "BIOS: fetch stage2.bin from this URL instead of the latest release")
	cmd.Flags().StringVar(&kernelFile, "kernel-file", "", "BIOS: local kernel instead of the latest release")
	cmd.Flags().StringVar(&kernelURL, "kernel-url", "", "BIOS: fetch the kernel from this URL instead of the latest release")
	cmd.Flags().StringVar(&initrdFile, "initrd-file", "", "BIOS: local initrd instead of the latest release")
	cmd.Flags().StringVar(&initrdURL, "initrd-url", "", "BIOS: fetch the initrd from this URL instead of the latest release")
	cmd.Flags().StringVar(&cmdlineFile, "cmdline-file", "", "BIOS: local cmdline.txt instead of the latest release")
	cmd.Flags().StringVar(&cmdlineURL, "cmdline-url", "", "BIOS: fetch cmdline.txt from this URL instead of the latest release")
	return cmd
}
